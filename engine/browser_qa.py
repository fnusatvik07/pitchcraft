#!/usr/bin/env python3
"""DeckForge browser-based QA — render a deck with Playwright (headless Chromium).
...
Outputs per-slide PNGs + a contact_sheet.png. The deckforge-browser-qa agent then
...
def main(argv):
    ...
    print("-> deckforge-browser-qa agent: read the PNGs and inspect each slide.")
    return 0
